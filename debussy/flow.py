...
or deletion of rows execute in a separate process from the Debussy CLI
...
from debussy.messaging import MsgQueueSender, RpcSender, OvsSender
from debussy.util import Config, append_path, ConnectionType
...
class OfMessage(debussy.messaging.ConsumableMessage):
    ...
    def consume(self, consumer):
        """Consume the message
           consumer: a debussy.of.OfManager instance to consume the message"""
...
class BarrierMessage(debussy.messaging.ConsumableMessage):
