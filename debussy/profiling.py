"""
Library for profiling operations in Debussy.

Debussy's profiling library uses message queues since a execution of a command
...
class ProfiledExecution(object):
    ...
    def __init__(self):
        self.counters = []
        self.receiver = debussy.messaging.MsgQueueReceiver(ProfileQueueId, self)
