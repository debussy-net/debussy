...
sys.path.append("/home/debussy/src/ravel/debussy")

from debussy.network import AddLinkMessage, NetworkProvider
from debussy.messaging import MsgQueueSender
...
if "PYTHONPATH" in os.environ:
    sys.path = os.environ["PYTHONPATH"].split(":") + sys.path
sys.path.append("/home/debussy/src/debussy")

from debussy.network import RemoveLinkMessage, NetworkProvider
from debussy.messaging import MsgQueueSender
...
from debussy.network import AddSwitchMessage, NetworkProvider
from debussy.messaging import MsgQueueSender
...
from debussy.network import RemoveSwitchMessage, NetworkProvider
from debussy.messaging import MsgQueueSender
...
from debussy.network import AddHostMessage, NetworkProvider
from debussy.messaging import MsgQueueSender
...
from debussy.network import RemoveHostMessage, NetworkProvider
from debussy.messaging import MsgQueueSender
